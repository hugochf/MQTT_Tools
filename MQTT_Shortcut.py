...
while True:
    ...
    if option == "0" : command = meter[1] + meter_id.strip("J?") + "01"
    else:
        if option == "1" : command = meter[7] + meter_id.strip("J?") + "00"
        else:
            if option == "3" : command = meter[7] + meter_id.strip("J?") + "023030"
            else: 
                if option == "4" : command = meter[1] + meter_id.strip("J?") + "07"
                else:
                    if option == "5" : command = meter[6] + meter_id.strip("J?") + "00"
                    else:
                        if option == "6" : command = meter[6] + meter_id.strip("J?") + "01"
                        else:
                            if option == "7" : command = meter[6] + meter_id.strip("J?") + "02"
                            else:
                                if option == "8" : command = meter[6] + meter_id.strip("J?") + "06000130"
                                else:
                                    if option == "9" : command = meter[1] + meter_id.strip("J?") + "05"
                                    else:
                                        if option == "11" : command = meter[1] + meter_id.strip("J?") + "04"
                                        else:
                                            if option == "12" : command = meter[1] + meter_id.strip("J?") + "03"
                                            else:
                                                if option == "2" : 
                                                    if (rbid == "")&(rbpwd == ""):
                                                        os.system('cls')
                                                    ...
                                                    command = meter[7] + meter_id.strip("J?") + "2C" + rbid.hex() + rbpwd.hex()
                                                else:
                                                    if option == "99" :
                                                        os.system('cls')
                                                        command = input("Input Manual Command: \r\n>>")
                                                        command.replace(" ", "")
                                                    else:
                                                        if option == "10" : 
                                                            os.system('cls')
                                                            print("FW Ver.     Lenght   CRC16")
                                                            print("_______________________________")
                                                            print("V1.20       94648    0x0000A714")
                                                            print("V2.19GT7    94364    0x000064CF")
                                                            print("V2.20       94648    0x000025A3")
                                                            print("V2.20G      94360    0x0000F9A4")
                                                            crc = hex(int(input("CRC Lenght? \r\n>>")))
                                                            crc = crc[2:]
                                                            for i in range(0, 8-len(crc)):
                                                                crc = "0" + crc
                                                            command = meter[1] + meter_id.strip("J?") + "08" + crc + "00000000"
                                                        else: 
                                                            if option == "13":
                                                                day = input("Days of Record?\r\n>>")
                                                                command = meter[1] + meter_id.strip("J?") + "02"+ hex(int(time.time())-int(day)*86400)[2:] + hex(int(time.time()))[2:]
                                                            else:
                                                                if option == "14" : 
                                                                    os.system('cls')
                                                                    print("Type     Function                                        Option")
                                                                    print("___________________________________________________________________________")
                                                                    print("0x00     Daily Meter Diagnostic                          0=Dis / 1=EN")
                                                                    print("0x01     Sunshine, temperature and humidity  sensor      0=Dis / 1=EN")
                                                                    print("0x02     Engineering Event Log                           0=Dis / 1=EN")
                                                                    print("0x03     Load Limit (for 2302H)                          0=Dis / 1=EN")
                                                                    print("0x04     Load current (for 2302H)                        0 - 255(A)")
                                                                    print("0x05     Auto-connect time (for 2302H)                   0 - 255(Sec)")
                                                                    print("0x06     Auto-connect count (for 2302H)                  0 – 255 (times)")
                                                                    print("0x07     Time to clear the Auto-connect time (for 2302H) 0 – 255 (Min)")
                                                                    print("0x08     Invert control switch state (for 2302H)         0=NO / 1=NC relay")
                                                                    print("0x09     PCS Communication Mode                          0=Direct / 1= Delta / 2=Omron")
                                                                    print("0x80     Interval for data sending                       0 – 255 (Min)")
                                                                    print("0x81     IoT Platform                                    0:None/G:IIL/X:ESI/A:AWS/M:MS/S:SB")
                                                                    print("0x82     Daily Diagnostic                                0=Dis/1=Comm only/2=Meter&Comm/3=Meter Control")
                                                                    print("0x83     Route B Communication Log                       0=Dis / 1=EN")
                                                                    type = input("Type? \r\n>>")
                                                                    option = input("Parameter? \r\n>>")                                                              
                                                                    command = meter[6] + meter_id.strip("J?") + "03"+ '{:02}'.format(str(type)) + '{:02}'.format(str(option)) + "000000000000"
                                                                else:
                                                                    if option == "15" : 
                                                                        os.system('cls')
                                                                        address=input("Move to 1:IIL(219) 2:IIL(129) 3:ESI 4:Manual input?\r\n>>")
                                                                        if (address == "1"):
                                                                            command = meter[6] + meter_id.strip("J?") + "05"+  "14" + "7C33342E39362E3135362E3231397C313838337C000000"
                                                                        else:
                                                                            if (address == "2"):
                                                                                command = meter[6] + meter_id.strip("J?") + "05"+  "14" + "7C33342E38342E3134332E3132397C313838337C000000"
                                                                            else:
                                                                                if (address == "3"):
                                                                                    command = meter[6] + meter_id.strip("J?") + "05"+  "14" + "7C35322E3135362E35362E3137307C313838337C000000"
                                                                                else:
                                                                                    if (address == "4"):
                                                                                        ip = input("IP address?\r\n>>").encode('utf-8').hex()
                                                                                        port = input("Port?\r\n>>").encode('utf-8').hex()
                                                                                        addrlenght = hex(int((len(ip)+len(port)+6)/2))[2:]
                                                                                        command = meter[6] + meter_id.strip("J?") + "05"+  addrlenght + "7C" + ip + "7C" + port + "7C"                                                                               
                                                                    else:
                                                                        if option == "16" : 
                                                                            os.system('cls')
                                                                            print("PCS Monitoring Test")
                                                                            print("___________________________________________")
                                                                            print("1. OMRON PCS")
                                                                            print("2. OMRON2 PCS")
                                                                            print("3. DELTA PCS")
                                                                            print("4. Panasonic PCS")
                                                                            pcs = input("Which PCS? \r\n>>")
                                                                            os.system('cls')
                                                                            if (pcs == '1'): #OMRON
                                                                            ...
                                                                            for i in range (0,len(pcscmd),1):
                                                                                if (pcs == '1'):
                                                                                    command = meter[8] + meter_id.strip("J?") + "0003020702" + pcscmd[i]
                                                                                if (pcs == '2'):
                                                                                    command = meter[8] + meter_id.strip("J?") + "0003020702" + pcscmd[i]
                                                                                if (pcs == '3'):
                                                                                    command = meter[8] + meter_id.strip("J?") + "0004000801" + pcscmd[i]
                                                                                if (pcs == '4'):
                                                                                    command = meter[8] + meter_id.strip("J?") + "0003020801" + pcscmd[i]
                                                                            ...
                                                                            if option == "18" : 
                                                                                os.system('cls')
                                                                                json = input("JSON? (In single line) \r\n>>")
                                                                                command = json.encode('utf-8').hex()
                                                                            else:
                                                                                if option == "19" :
                                                                                    os.system('cls')
                                                                                    exkey = input("Input Data Key\r\n>>")
                                                                                    print("1. Send Data Key\n")
                                                                                    print("2. Send Successful ACK\n")
                                                                                    option = input("Which Step?\r\n>>")
                                                                                    if option == "1" :
                                                                                        command = meter[0] + meter_id.strip("J?") + "00" + exkey.encode('utf-8').hex()
                                                                                    else:
                                                                                        if option == "2" :
                                                                                            command = meter[0] + meter_id.strip("J?") + "02"
                                                                                        else:
                                                                                            print("Wrong Input")
                                                                                            time.sleep(1)
                                                                                else:
